...
placeholders = {
    ...
    "polling/README.md": (
        ...
        "Hier entsteht die Anbindung für wiederkehrende Prüfungen oder "
        "externe Trigger.\n"
    ),
    ...
    "human_in_the_loop/README.md": (
        ...
        "Hier entsteht später z.B. die Integration für manuelle Freigaben "
        "oder Rückfragen.\n"
    ),
    "reminders/README.md": (
        "Platzhalter für Reminder- und Eskalations-Workflows.\n"
        "Hier werden Module für Erinnerungen, automatische Folgeaktionen "
        "etc. ergänzt.\n"
    ),
    "README.md": (
        "# Agentic-Intelligence-Research\n\n"
        "Dieses Repository enthält Workflows und Komponenten für "
        "agentenbasierte Prozessautomatisierung "
        "(z. B. rund um Google Calendar, Event Handling, Logging, "
        "Kommunikation).\n\n"
        "## Struktur\n\n"
        "- `agents/`: Zentrale Agenten (z.B. E-Mail-Agent)\n"
        "- `logs/`: Logging-Module für Events, Workflows etc.\n"
        "- `templates/`: Zentrale Templates für E-Mails und weitere "
        "Kommunikation\n"
        "- `polling/`, `extraction/`, `human_in_the_loop/`, `reminders/`: "
        "Platzhalter für geplante Erweiterungen\n"
